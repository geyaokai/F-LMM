...
from mmdet.datasets import RefCocoDataset # type: ignore
from mmdet.datasets.transforms import LoadAnnotations # type: ignore
from mmdet.models import CrossEntropyLoss, DiceLoss # type: ignore  
from mmseg.models.backbones.unet import InterpConv # type: ignore
...
train_dataloader = dict(
    ...
    pin_memory=True,           # 添加这行（如果还没有）
    prefetch_factor=2,         # 添加这行，从默认值减小
...
load_from = '/data/gyk/F-LMM/work_dirs/frozen_deepseek_vl_1_3b_chat_unet_sam_l_refcoco_png/iter_100.pth'
