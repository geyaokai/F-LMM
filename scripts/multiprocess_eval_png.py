...
if __name__ == '__main__':
    ...
    parser.add_argument('--log-file', default='eval_png.log', type=str, help='Path to save log file')  # 新增：日志文件参数
    ...
    logger.info(f'Device: {accelerator.device}')  # 新增：日志记录设备信息
    ...
    if accelerator.is_main_process:
        ...
        logger.info(f"aIoU: {AA}, aIoU_singulars: {AA_singulars}, aIoU_plurals: {AA_plurals}, "
                    f"aIoU_things: {AA_things}, aIoU_stuff: {AA_stuff}, aAcc@0.5: {accuracy}, "
                    f"pixel_accs: {pixel_accs}")  # 新增：日志记录评估结果
